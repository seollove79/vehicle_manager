...
$asHistoryNum = $_POST['as_history_num'];
...
$sqlStr = "update as_history set 
    ...
    etc_content = :etc_content where num = :as_history_num";
...
$conn = null;
echo "<script>alert('AS 이력이 수정되었습니다.');opener.location.reload();self.close();</script>";
exit;
?>